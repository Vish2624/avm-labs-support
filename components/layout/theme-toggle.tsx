...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-8 w-[60px] shrink-0 items-center rounded-full border border-border bg-muted p-[3px] transition-[background,border-color] duration-300 hover:border-primary focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none dark:bg-primary/25"
    >
      ...
      <span className="relative z-10 grid size-6 place-items-center rounded-full bg-card shadow-[0_1px_3px_oklch(0.2_0.02_258/0.25)] transition-transform duration-350 ease-[cubic-bezier(.34,1.56,.64,1)] dark:translate-x-7">
